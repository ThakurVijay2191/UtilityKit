...
public struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: "com.apple.utilityKit", account: "userIdentifier").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: "com.apple.utilityKit", account: "userIdentifier").deleteItem()
        } catch {
